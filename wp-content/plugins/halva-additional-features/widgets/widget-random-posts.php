 ...
 * Register widget
 */
add_action( 'widgets_init', 'halva_additional_features_register_random_widget' );

function halva_additional_features_register_random_widget() {
	register_widget( 'halva_additional_features_random_widget' );
}


/**
 * Class halva_additional_features_random_widget
 */
class halva_additional_features_random_widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description'	=> esc_html__( 'Displays a list of random posts.', 'halva-additional-features' ),
		);
		parent::__construct( 'halva_random_widget', esc_html__( 'Halva: Random Posts', 'halva-additional-features' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Random posts', 'halva-additional-features' );
